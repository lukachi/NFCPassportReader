...
struct MainView : View {
    ...
    @State public var showScanMRZ : Bool = false
    @State public var showSavedPassports : Bool = false
    @State public var gettingLogs : Bool = false

    @State var page = 0
    
    @State var bgColor = Color( UIColor.systemBackground )
    
    public let passportReader = PassportReader()
