...
public class PACEInfo : SecurityInfo {
    ...
    public func createMappingKey( ) throws -> OpaquePointer {
        ...
        switch try getKeyAgreementAlgorithm() {
            case "DH":
                Logger.pace.trace( "Generating DH mapping keys")
                ...
                switch try getParameterSpec() {
                    case 0:
                        Logger.pace.trace( "Using DH_get_1024_160" )
                        dhKey = DH_get_1024_160()
                    case 1:
                        Logger.pace.trace( "Using DH_get_2048_224" )
                        dhKey = DH_get_2048_224()
                    case 2:
                        Logger.pace.trace( "Using DH_get_2048_256" )
            ...
            case "ECDH":
                ...
                Logger.pace.trace( "Generating ECDH mapping keys from parameterSpec - \(parameterSpec)")
